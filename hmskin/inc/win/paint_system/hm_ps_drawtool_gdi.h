#ifndef __HM_PS_DRAWTOOL_GDI_H__
#define __HM_PS_DRAWTOOL_GDI_H__
#include "win\hm_export_defs.h"
#include "win\paint_system\hm_ps_drawtool_i.h"
//
class HMLIB_API hm_ps_drawtool_gdi : public hm_ps_drawtool_i 
{
public:
	virtual ~hm_ps_drawtool_gdi();
	
public:
	static hm_ps_drawtool_gdi* getInstance();
...
#endif //__HM_PS_DRAWTOOL_GDI_H__